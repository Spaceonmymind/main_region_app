...
const welcomeText = [
  ...
  '',
  'Здесь собраны полезные региональные сервисы и актуальные ресурсы нашего региона — все для того, чтобы вам было удобно и быстро решать повседневные задачи.',
  '',
  'Нажмите кнопку «Открыть сервисы», выберите нужную тематическую категорию или воспользуйтесь поиском.',
].join('\n');
